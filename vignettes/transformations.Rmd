...
To use this transformation for modelling, we can pair the transformation with its back transformation using the `new_transformation` function from fablelite, which accepts two functions: first the transformation, and second the back-transformation.
```{r scaled-logit}
