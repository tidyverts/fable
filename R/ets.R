...
#' - It does not support missing values. You can complete missing values in the data with imputed values (e.g. with `tidyr::fill`, or by fitting a different model type and then calling `interpolate`) before fitting the model.
#' 
#' \subsection{error}{
